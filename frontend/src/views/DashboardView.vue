<template>
  <div class="pt-6">
    ...
    <div v-if="loading" class="text-center text-gray-500 py-12">Loading stats...</div>
    ...
    <template v-else-if="stats">
      ...
      <div class="mt-8">
        ...
        <div class="flex items-end gap-1 h-24"
          :class="timerStore.settings.lightTheme ? 'bg-white rounded-xl p-3 border border-gray-200' : 'bg-gray-900 rounded-xl p-3 border border-gray-800'"
        >
      ...
      <div class="mt-8">
        ...
        <div class="space-y-2">
          <div v-for="mode in stats.mode_breakdown" :key="mode.mode"
            class="flex items-center justify-between rounded-lg px-4 py-3"
            :class="timerStore.settings.lightTheme ? 'bg-white border border-gray-200' : 'bg-gray-900 border border-gray-800'"
          >
    ...
    <div v-else-if="!loading && !stats" class="text-center text-gray-500 py-12">
      No stats yet. Complete a few focus sessions to see your progress.
    </div>
  </div>
</template>
